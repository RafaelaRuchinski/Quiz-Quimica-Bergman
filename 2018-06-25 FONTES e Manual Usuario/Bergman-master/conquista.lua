--  ----------------------------------------------------------------------------
--  projectname:
--  filename:     conquista.lua
--  description: Contém a tela de conquistas do jogo
...
function scene:create(event)
  -- Busco o grupo principal para a cena
	...
	local background = display.newImageRect(sceneGroup, "images/cena-conquista.png", 1280, 720)
