...
local function gotoClassificacao()
  composer.gotoScene("classificacao")
end
...
local function createControl(group)
  ...
  btnBack:addEventListener("tap", gotoClassificacao)
...
function scene:create(event)
  ...
  local background = display.newImageRect(sceneGroup, "images/classificacao2.png", 1280, 720)
