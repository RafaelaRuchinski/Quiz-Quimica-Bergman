...
function scene:create(event)
  ...
  local txtLuiz = display.newText(sceneGroup, "Luiz Henrique Bosse", display.contentCenterX, 300, native.systemFont, 50)
  txtLuiz:setFillColor(color.preto.r, color.preto.g, color.preto.b)
