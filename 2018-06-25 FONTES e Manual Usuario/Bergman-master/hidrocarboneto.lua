...
local function gotoHidrocarbonetos2()
  composer.gotoScene("hidrocarboneto2")
end
...
local function createControl(group)
  ...
  btnNext:addEventListener("tap", gotoHidrocarbonetos2)
end
...
function scene:create(event)
  ...
  local background = display.newImageRect(sceneGroup, "images/hidrocarbonetos.png", 1280, 720)
