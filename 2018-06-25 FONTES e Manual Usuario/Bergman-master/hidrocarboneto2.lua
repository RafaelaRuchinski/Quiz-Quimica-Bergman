...
local function gotoHidrocarbonetos()
  composer.gotoScene("hidrocarboneto")
end
...
local function createControl(group)
  ...
  local btnBack = display.newImageRect(group,"images/button-back.png", 64, 64)
  btnBack.x = display.contentWidth - 830
  btnBack.y = display.contentHeight - 90
  btnBack:addEventListener("tap", gotoHidrocarbonetos)
end
...
function scene:create(event)
  ...
  local background = display.newImageRect(sceneGroup, "images/hidrocarbonetos2.png", 1280, 720)
